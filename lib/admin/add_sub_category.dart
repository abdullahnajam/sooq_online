...
import 'package:toast/toast.dart';import 'package:firebase_storage/firebase_storage.dart' as firebase_storage;
...
class _AddSubCategoryState extends State<AddSubCategory> {
  submitData(String url){
    ...
    databaseReference.child("categories").child(widget.id).child("sub_categories").push().set({
      ...
      Navigator.pushReplacement(context, MaterialPageRoute(builder: (BuildContext context) => AddSubCategory(widget.id)));
  ...
  Future<List<CategoryModel>> getCategoryList() async {
    ...
    final databaseReference = FirebaseDatabase.instance.reference();
    await databaseReference.child("categories").child(widget.id).child("sub_categories").once().then((DataSnapshot dataSnapshot){
                ...
                child: Stack(
                  children: [
                    ...
                    Container(
                      ...
                      child: Text("Sub Categories",style: TextStyle(fontWeight: FontWeight.w700,fontSize: 13),),
                    ),
