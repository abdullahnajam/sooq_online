            ...
            child: Column(
              ...
              children: [
                Container(
                  ...
                  child: Text("Values",textAlign: TextAlign.center,style: TextStyle(fontSize: 20,color:Colors.black,fontWeight: FontWeight.w600),),
                ),
                Container(
                  margin: EdgeInsets.all(10),
                  child: TextField(
                    controller: _controller,
                    decoration: InputDecoration(hintText:"Enter Value",contentPadding: EdgeInsets.only(left: 10)),
                  ),
                ),
                Container(
                  margin: EdgeInsets.all(10),
                  child: TextField(
                    ...
                    decoration: InputDecoration(hintText:"Enter Value (Arabic)",contentPadding: EdgeInsets.only(left: 10)),
                  ),
                ),
                Container(
                    margin: EdgeInsets.all(10),
                ...
                child: Stack(
                  children: [
                    ...
                    Container(
                      ...
                      child: Text("Value",style: TextStyle(fontWeight: FontWeight.w700,fontSize: 13),),
                    ),
