...
import 'package:propertymarket/admin/add_values.dart';
            ...
            child: Column(
              ...
              children: [
                Container(
                  ...
                  child: Text("Attributes",textAlign: TextAlign.center,style: TextStyle(fontSize: 20,color:Colors.black,fontWeight: FontWeight.w600),),
                ),
                Container(
                  margin: EdgeInsets.all(10),
                  child: TextField(
                    controller: _controller,
                    decoration: InputDecoration(hintText:"Enter Attributes",contentPadding: EdgeInsets.only(left: 10)),
                  ),
                ),
                Container(
                  margin: EdgeInsets.all(10),
                  child: TextField(
                    ...
                    decoration: InputDecoration(hintText:"Enter Attributes (Arabic)",contentPadding: EdgeInsets.only(left: 10)),
                  ),
                ),
                Container(
                    margin: EdgeInsets.all(10),
                    child: RaisedButton(
                      ...
                      child: Text("Add Attributes",style: TextStyle(color: Colors.white),),
                    )
                ),
                SizedBox(height: 15,),
              ],
                ...
                child: Stack(
                  children: [
                    ...
                    Container(
                      ...
                      child: Text("Attributes",style: TextStyle(fontWeight: FontWeight.w700,fontSize: 13),),
                    ),
