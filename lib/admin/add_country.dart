...
class _AddCountryState extends State<AddCountry> {
  submitData(){
    ...
    databaseReference.child("country").push().set({
      ...
      Navigator.pushReplacement(context, MaterialPageRoute(builder: (BuildContext context) => AddCountry()));
            ...
            child: Column(
              ...
              children: [
                Container(
                  ...
                  child: Text("Country",textAlign: TextAlign.center,style: TextStyle(fontSize: 20,color:Colors.black,fontWeight: FontWeight.w600),),
                ),
                Container(
                  margin: EdgeInsets.all(10),
                  child: TextField(
                ...
                Container(
                    ...
                    child: RaisedButton(
                      ...
                      child: Text("Add Country",style: TextStyle(color: Colors.white),),
                    )
                ),
                SizedBox(height: 15,),
              ],
                ...
                child: Stack(
                  children: [
                    ...
                    Container(
                      ...
                      child: Text("Country",style: TextStyle(fontWeight: FontWeight.w700,fontSize: 13),),
                    ),
                                        ...
                                        children: [
                                          Container(
                                              ...
                                              child: RaisedButton(
                                                onPressed: ()async{
                                                  final databaseReference = FirebaseDatabase.instance.reference();
                                                  await databaseReference.child("country").child(snapshot.data[index].id).remove().then((value) {
